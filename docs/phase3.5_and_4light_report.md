...
### 感情語トークンベースのベクトル
- `results/emotion_vectors/gpt2_vectors_token_based.pkl`
- `results/emotion_vectors/pythia-160m_vectors_token_based.pkl`
- `results/emotion_vectors/gpt-neo-125m_vectors_token_based.pkl`

### モデル間類似度テーブル
- `results/cross_model_similarity_token_based.csv`
...
### モデル間サブスペースoverlap
- `results/cross_model_subspace_overlap.csv`
