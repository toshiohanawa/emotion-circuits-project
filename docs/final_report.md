...
### 活性データ
- `results/activations/gpt2/` - 4ファイル
- `results/activations/pythia-160m/` - 4ファイル
- `results/activations/gpt-neo-125m/` - 4ファイル

### 感情方向ベクトル
- `results/emotion_vectors/gpt2_vectors.pkl`（文末ベース）
- `results/emotion_vectors/gpt2_vectors_token_based.pkl`（感情語トークンベース）
- 同様にPythia-160M、GPT-Neo-125M用

### 感情サブスペース
- `results/emotion_subspaces/gpt2_subspaces.pkl`
- `results/emotion_subspaces/pythia-160m_subspaces.pkl`
- `results/emotion_subspaces/gpt-neo-125m_subspaces.pkl`

### 分析結果テーブル
- `results/cross_model_similarity.csv`（文末ベース）
- `results/cross_model_similarity_token_based.csv`（感情語トークンベース）
- `results/cross_model_subspace_overlap.csv`（サブスペースoverlap）

### Activation Patching結果
- `results/patching/gpt2_patching_results_v2.pkl`
- `results/patching/gpt-neo-125m_patching_results.pkl`
