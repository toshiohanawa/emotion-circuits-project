...
### データファイル
- `results/evaluation/sentiment_eval_baseline.json`: Baseline sentiment評価結果（JSON）
- `results/evaluation/sentiment_eval_baseline.pkl`: Baseline sentiment評価結果（Pickle）
- `results/evaluation/iterative_patching_gratitude.pkl`: Iterative patching結果
- `results/evaluation/swap_patching.pkl`: Swap patching結果

### 可視化ファイル
- `results/plots/sentiment/emotion_keyword_frequencies.png`: 感情キーワード頻度ヒストグラム
- `results/plots/sentiment/sentiment_scores.png`: Sentimentスコア分布
- `results/plots/sentiment/sentiment_comparison.png`: Sentimentスコア比較散布図
...
**結果ファイル**: `results/alignment/k_sweep_gpt2_pythia.json` / `.pkl`
...
**可視化**: `results/plots/k_sweep/`に以下のプロットを生成
...
**結果ファイル**: `results/alignment/model_alignment_gpt2_pythia.pkl`
**線形写像ファイル**: `results/alignment/linear_maps/layer_{3,5,7,9,11}.pt`
...
**可視化**: `results/plots/alignment/`に以下のプロットを生成
...
**結果ファイル**: `results/alignment/subspace_alignment_gpt2_pythia.pkl`
...
**可視化**: `results/plots/alignment/procrustes/`にプロットを生成
...
#### 実験結果ファイル
- `results/alignment/k_sweep_gpt2_pythia.json` / `.pkl`: k-sweep実験結果
- `results/alignment/model_alignment_gpt2_pythia.pkl`: 線形写像アライメント結果
- `results/alignment/subspace_alignment_gpt2_pythia.pkl`: Procrustesアライメント結果
- `results/alignment/linear_maps/layer_{3,5,7,9,11}.pt`: 学習した線形写像（PyTorch形式）

#### 可視化ファイル
- `results/plots/k_sweep/`: k-sweep結果の可視化
- `results/plots/alignment/`: 線形写像アライメントの可視化
- `results/plots/alignment/procrustes/`: Procrustesアライメントの可視化
