...
### GPT-2 small
以下のファイルが `results/baseline/activations/gpt2/` に保存されました：
...
### Pythia-160M
以下のファイルが `results/baseline/activations/pythia-160m/` に保存されました：
...
### GPT-Neo-125M
以下のファイルが `results/baseline/activations/gpt-neo-125m/` に保存されました：
