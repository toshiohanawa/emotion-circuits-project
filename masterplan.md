...
* [ ] Phase 0〜7 のどこかを振り返っている（過去の航海ログを読みたいとき）

  → Section 4 の該当フェーズを読み返す。
* [ ] Phase 7.5（統計的厳密性）を進めている（結果を固めたいとき）

  → T3（Random Baseline & Statistical Testing）の設計を確認する。
* [ ] Phase 8 以降（スケーリング／多言語／応用）を計画している（未来の航路を描きたいとき）
