...
def main():
    ...
    output_dir = Path(args.output_dir) if args.output_dir else results_dir / "plots" / "cross_model"
    output_table = Path(args.output_table) if args.output_table else results_dir / "cross_model_similarity.csv"
    output_table.parent.mkdir(parents=True, exist_ok=True)
    
    # モデルベクトルを読み込み
    print("Loading model vectors...")
    model_vectors = load_model_vectors(args.models, vectors_dir)
